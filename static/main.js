document.addEventListener('DOMContentLoaded', function() {
    ...
    const formIds = [
        ...
        "crane10Form",
        "craneOnTrackForm",
        "craneOnTrack75_100TonForm",
        "dumpTruckForm",
        "truckSemiTrailerForm",
        "generatingSetForm",
        "motorGraderForm",
        "trackLoaderForm",
        "wheelLoaderForm",
        "threeWheelLoaderForm",
        "tandemRollerForm",
        "pneumaticTireRollerForm",
        "sheepsfootRollerForm",
        "vibratoryRollerForm",
        "concreteVibratorForm",
        "waterPumpForm",
        "jackHammerForm",
        "blendingEquipmentForm",
        "asphaltLiquidMixerForm",
        "pedestrianRollerForm",
        "tamperForm",
        "vibratingRammerForm",
        "pulviMixerForm",
        "concretePumpForm",
        "pileDriverHammerForm",
        "weldingSetForm",
        "boredPileDrillingForm",
        "roadMillingForm",
        "rockDrillBreakerForm",
        "coldRecyclerForm",
        "hotRecyclerForm",
        "aggregateSpreaderForm",
        "asphaltDistributorForm",
        "concretePavingMachineForm",
        "batchingPlantForm",
        "concreteBreakerForm",
        "asphaltTankTruckForm",
        "cementTankTruckForm",
        "concreteTruckMixerForm",
        "borePileMachine60Form",
        "aplikatorCatThermoplasticForm",
        "kapalTongkangForm",
        "forkLiftForm",
        "concreteCutterForm",
        "powerBroomForm",
        "asphaltSlurrySealTruckForm",
        "truckMixerAgitatorForm",
        "selfPropelledMixerForm",
        "stressingJackForm",
        "groutingPumpForm",
        "trailerTronton30tForm",
        "pontonForm",
        "boilerForm",
        "drumMixerForm",
        "hcaForm",
      ...
      const alatData = [
        ...
        "Dump Truck",
        "Truck Semi Trailer 15 ton",
        "Generating Set (Genset)",
        "Motor Grader",
        "Track Loader",
        "Wheel Loader",
        "Three Wheel Loader (TWR/Macadam Roller)",
        "Tandem Roller",
        ...
        "Pile Driver-Hammer",
        "Welding Set",
        "Bored Pile Drilling Machine Max. dia. 2 m",
        ...
        "Bore Pile Machine dia. 60 cm",
        "Aplikator Cat Marka Jalan Thermoplastic",
        "Kapal Tongkang/Perahu",
        "Fork Lift",
        "Concrete Cutter",
        "Power Broom",
        ...
        "Stressing Jack",
        "Grouting Pump",
        "Trailer Tronton 30 T",
        "Ponton + Tug Boat",
        "Pre Heater/ Boiler",
        "Drum Mixer Khusus",
        "Hot Compressor Air Lance (HCA)",
        "Silicon Seal Pump",
        ...
        "Mesin Amplas Kayu",
        "Stamper",
        "Lift Barang, Tinggi 6-10 lantai (20-40 m), Bm 1,0 ton",
        "Lift Barang, Tinggi 10-24 lantai (40-100 m), Bm 1,0 ton",
        "Lift Barang, Tinggi 10-24 lantai (40-100 m), Bm 2,0 ton",
